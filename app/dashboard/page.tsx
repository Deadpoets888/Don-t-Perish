...
export default function Dashboard() {
  ...
  return (
    <div className={`min-h-screen transition-colors ${darkMode ? 'dark bg-gray-900' : 'bg-gray-50'}`}>
      <div className={`shadow-sm border-b transition-colors ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white'}`}>
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                <i className={`ri-user-line text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}></i>
                <select
                  value={userRole}
              ...
              >
                <i className={`text-lg ${darkMode ? 'ri-sun-line' : 'ri-moon-line'}`}></i>
              </button>

              <div className={`text-sm transition-colors ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                Total Products: <span className={`font-medium ${darkMode ? 'text-white' : 'text-gray-900'}`}>{products.length}</span>
              </div>
            </div>
          </div>
        </div>
